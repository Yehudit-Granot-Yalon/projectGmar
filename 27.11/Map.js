...
function setRow(json) {
console.log("save point",savePoints)
if(json.points[0][0]==savePoints[0]&&json.points[0][1]==savePoints[1]){
 ...
 var lon=json.points[0][0] ;
  //alert(json);
 var lat=json.points[0][1] ;
 console.log(lon)
 
 console.log(lat)
 const point = new Point(fromLonLat([lon,lat]));
    const feature = new Feature(point);
    feature.setProperties({ "x":lon, "y":lat, "height": 1000, "velocity": 98, "direction": 80})
    vectorSource.addFeature(feature);
   map.getView().setCenter( fromLonLat([lon,lat]));
  //}
}
...
//   //  const feature = new Feature(point);
//   //  feature.setProperties({ "x": x, "y": y, "height": 1000, "velocity": 98, "direction": 80})
//   //   vectorSource.addFeature(feature);
//   //   map.getView().setCenter( fromLonLat([x, y]));
//   //}
//   }
