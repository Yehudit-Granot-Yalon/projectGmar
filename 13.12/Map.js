...
function enterArrKalman(coordinate){
  console.log(" coordinate before observations",coordinate);
...
function initSavePoint(json){
  ...
  console.log("init save point",savePoint)
}
...
map.on('click', function (evt) {
 ...
 map.on('pointermove', function (evt) {
  ...
  var str="Lat: "+pointDetails[18]+"<br>Lon: "+pointDetails[19]+"<br>AGL: "+pointDetails[20]+"<br>Velocity: "+pointDetails[12]+"<br>Range: "+pointDetails[8]
